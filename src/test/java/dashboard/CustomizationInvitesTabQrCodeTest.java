...
public class CustomizationInvitesTabQrCodeTest extends DashboardTestBase {


    @Test(testName = "Verify the functionality of the 'invite your customer' modal appear on invites QR Code section")
